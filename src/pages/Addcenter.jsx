 ...
 const id = localStorage.getItem("id");
  ...
  console.log(values);
   ...
   const handleCheck=(event)=>{
    ...
    setWeekday((pre)=>[...pre,event.target.value])
  else{
          ...
          <Row>
            <Col sm={6} md={12} lg={7}>
              <Form>
                <Row className="p-1">
                  <Col>
                    <FormCheck id="myCheckbox1" label="Sun" name="sun" value="sun" checked={weekday.includes("sun")} onChange={handleCheck}/>
                  </Col>
                  <Col className="ms-2">
                    <FormCheck id="myCheckbox2" label="Mon"  name="Mon" value="Mon"  checked={weekday.includes("Mon")}  onChange={handleCheck}/>
                  </Col>
                  <Col className="ms-2">
                    <FormCheck id="myCheckbox3" label="Tue"  name="Tue" value="Tue"  checked={weekday.includes("Tue")}  onChange={handleCheck}/>
                  </Col>
                  <Col className="ms-2">
                    <FormCheck id="myCheckbox4" label="Wed"  name="Wed" value="Wed"  checked={weekday.includes("Wed")} onChange={handleCheck}/>
                  </Col>
                  <Col className="ms-2">
                    <FormCheck id="myCheckbox5" label="Thu"  name="Thu" value="Thu"  checked={weekday.includes("Thu")}  onChange={handleCheck}/>
                  </Col>
                  <Col className="ms-2">
                    <FormCheck id="myCheckbox6" label="Fri"  name="Fri" value="Fri"  checked={weekday.includes("Fri")} onChange={handleCheck}/>
                  </Col>
                  <Col>
                    <FormCheck id="myCheckbox7" label="Sat"  name="Sat" value="Sat"  checked={weekday.includes("Sat")}  onChange={handleCheck}/>
                  </Col>
                </Row>
                <Row>
                  <Col sm={6} md={4} lg={4}>
